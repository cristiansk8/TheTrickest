  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-900 via-accent-purple-900 to-neutral-900 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto mb-8">
        <div className="bg-accent-purple-500 p-1 rounded-lg shadow-2xl">
          <div className="bg-neutral-900 rounded-lg p-6">
            <h1 className="text-3xl md:text-5xl font-black text-transparent bg-clip-text bg-accent-purple-400 uppercase tracking-wider text-center">
              👥 EQUIPOS
            </h1>
      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        {myTeam ? (
          <div className="bg-accent-purple-500 p-1 rounded-lg">
            <div className="bg-neutral-900 rounded-lg p-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-4">
                    {myTeam.logo ? (
                      ...
                      <div className="w-16 h-16 rounded-lg bg-gradient-to-br accent-purple-500 flex items-center justify-center text-white font-bold text-2xl">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-neutral-900 border-4 border-accent-purple-500 rounded-lg p-6 w-full max-w-md">
            <h2 className="text-2xl font-black text-transparent bg-clip-text bg-accent-purple-400 uppercase mb-6 text-center">
              ⚡ Crear Equipo
            </h2>
