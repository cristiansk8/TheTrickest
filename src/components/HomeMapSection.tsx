...
const UnifiedMap = dynamic(() => import('@/components/organisms/UnifiedMap'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[500px] rounded-xl border-4 border-cyan-400 bg-neutral-900 flex items-center justify-center">
    ...
    <div className="py-16 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-neutral-300 text-lg md:text-xl font-bold max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">
          ...
          {/* Skateparks */}
          <div className="bg-neutral-800 border-4 border-cyan-400 rounded-xl p-6 text-center shadow-2xl shadow-cyan-500/30 hover:scale-105 transition-transform">
          ...
          {/* Skateshops */}
          <div className="bg-neutral-800 border-4 border-pink-400 rounded-xl p-6 text-center shadow-2xl shadow-pink-500/30 hover:scale-105 transition-transform">
          ...
          {/* Total Skaters */}
          <div className="bg-neutral-800 border-4 border-purple-600 rounded-xl p-6 text-center shadow-2xl shadow-purple-600/30 hover:scale-105 transition-transform">
          ...
          <button
            ...
            className={`px-6 py-3 rounded-lg font-black uppercase tracking-wider transition-all ${
              showSpots
                ...
                : 'bg-neutral-700 hover:bg-neutral-600 text-neutral-300 border-2 border-slate-600'
            }`}
          >
        ...
        {loading ? (
          ...
          <div className="w-full h-[500px] rounded-xl border-4 border-yellow-400 bg-neutral-900 flex flex-col items-center justify-center gap-4">
        ...
        <div className="mt-8 text-center">
          <Link href="/spots">
            <button className="bg-accent-purple-600 hover:bg-accent-purple-700 text-white font-black uppercase tracking-wider text-lg px-8 py-4 rounded-xl border-4 border-white shadow-2xl shadow-accent-purple-500/50 hover:shadow-purple-400/70 transition-all transform hover:scale-105">
              🔍 VER MAPA COMPLETO
            </button>
          </Link>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-12">
          {/* Skateparks Card */}
          <div className="bg-neutral-800 border-4 border-cyan-400 rounded-xl p-6 shadow-2xl shadow-cyan-500/20">
          ...
          {/* Skateshops Card */}
          <div className="bg-neutral-800 border-4 border-pink-400 rounded-xl p-6 shadow-2xl shadow-pink-500/20">
            <div className="flex items-center gap-3 mb-4">
              <div className="text-4xl">🏪</div>
