...
export const Sidebar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <Link href="/">
          <div className="bg-accent-cyan-500 p-[3px] rounded-lg shadow-lg shadow-accent-cyan-500/30 hover:shadow-accent-cyan-500/50 transition-all cursor-pointer">
            <div className="bg-neutral-900 rounded-lg p-4">
              <h1 className="text-xl font-black text-accent-cyan-400 uppercase tracking-wider text-center">
                🛹 TRICKEST
              </h1>
      ...
      <div className="px-4 mb-4">
        <div className="bg-accent-yellow-500 p-[3px] rounded-lg">
      ...
      <div className="px-4 mb-6">
        <div className="bg-accent-purple-500 p-[3px] rounded-lg">
          <div className="bg-neutral-900 rounded-lg p-4">
      ...
      <div className="px-4 pb-6 mt-auto">
        <button
          ...
          className="w-full bg-accent-red-500 hover:bg-accent-red-400 p-[3px] rounded-lg shadow-lg shadow-accent-red-500/30 hover:shadow-accent-red-500/50 transition-all"
        >
